  ...
  return `
    ...
    <html lang="en">
      ...
      <body style="margin: 0; padding: 0; background-color: #f8fafc; font-family: Arial, Helvetica, sans-serif;">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #f8fafc; margin: 0; padding: 0;">
          <tr>
            <td align="center" style="padding: 40px 20px;">
              
              <!-- Email Content Table -->
              <table width="600" border="0" cellspacing="0" cellpadding="0" style="background-color: #ffffff; border-radius: 8px; max-width: 600px;" bgcolor="#ffffff">
                
                <!-- Header Section -->
                <tr>
                  <td style="background-color: #19363C; padding: 40px 48px; text-align: center;" bgcolor="#19363C" align="center">
                    
                    <!-- Logo Container -->
                    <table border="0" cellspacing="0" cellpadding="0" style="margin: 0 auto 24px auto;">
                      <tr>
                        <td style="background-color: #ffffff; padding: 16px; border-radius: 12px; text-align: center;" bgcolor="#ffffff" align="center">
                          <img src="https://qrawynczvedffcvnympn.supabase.co/storage/v1/object/public/public-assets/logo_nav.webp" 
                               alt="Quilltips Logo" 
                               width="60" 
                               height="60" 
                               style="display: block; border: 0; border-radius: 6px; width: 60px; height: 60px;">
                        </td>
                      </tr>
                    </table>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td align="center" style="padding: 40px 0;">
                          <!--[if mso]>
                          <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${ctaUrl}" style="height:48px;v-text-anchor:middle;width:200px;" arcsize="50%" stroke="f" fillcolor="#FFD166">
                            <w:anchorlock/>
                          ...
                          <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td style="border-radius: 24px; background-color: #FFD166;" bgcolor="#FFD166">
                                <a href="${ctaUrl}" 
                                   style="display: inline-block; padding: 16px 32px; font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #19363C; text-decoration: none; border-radius: 24px; min-width: 140px; text-align: center;"
                                   target="_blank">
                                  ${cta}
                                </a>
                              </td>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #4A5568; text-align: center; padding: 24px 0;" align="center">
                          or visit <a href="https://quilltips.co" style="color: #19363C; text-decoration: none; font-weight: bold;" target="_blank">quilltips.co</a>
                        </td>
                      </tr>
                    </table>
                ...
                <!-- Footer Section -->
                <tr>
                  <td style="background-color: #F7FAFC; padding: 32px 48px; text-align: center; border-top: 1px solid #E2E8F0;" bgcolor="#F7FAFC" align="center">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #6B7280; line-height: 1.5; text-align: center;" align="center">
                          ...
                          or contact us at <a href="mailto:hello@quilltips.co" style="color: #19363C; text-decoration: none; font-weight: bold;" target="_blank">hello@quilltips.co</a>
                        </td>
                      </tr>
                    </table>
                  </td>
