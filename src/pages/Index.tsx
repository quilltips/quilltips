    ...
    <div className="w-full max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12">
      ...
      <div className="mx-auto w-full max-w-5xl mt-32 px-4">
        ...
        <div className="flex justify-center mt-16">
          <RouterLink to="/how-it-works">
            <Button variant="outline" className="rounded-full px-10 border-[#19363C] text-[#19363C] hover:bg-[#19363C] hover:text-white" data-plausible-event="how-it-works">
              Learn more
            </Button>
          </RouterLink>
        </div>
      ...
      <div className="mx-auto w-full max-w-4xl mt-32 px-4">
        ...
        <div className="flex justify-center mt-12">
          <RouterLink to="/about">
            <Button variant="outline" className="rounded-full px-10 flex items-center gap-2 border-[#19363C] text-[#19363C] hover:bg-[#19363C] hover:text-white" data-plausible-event="about-quilltips">
              Learn more about us
            </Button>
          </RouterLink>
        </div>
