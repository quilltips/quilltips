...
export const AuthorCard = ({ id, name, avatarUrl, slug, joinedYear }: AuthorCardProps) => {
  ...
  return (
    ...
    >
      <div className="bg-card border border-border rounded-2xl p-6 transition-all duration-200 hover:shadow-lg hover:-translate-y-1 h-full">
        <div className="flex flex-col items-center space-y-4">
          <Avatar className="h-20 w-20 md:h-24 md:w-24 ring-2 ring-border transition-colors">
          ...
          <div className="text-center space-y-2 min-h-[80px] flex flex-col justify-start">
